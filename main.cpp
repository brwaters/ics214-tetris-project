...
int main() {
  ...
  backgroundTexture.loadFromFile(
      "../images/background.png"); // load the background sprite
  backgroundSprite.setTexture(backgroundTexture);

  blockTexture.loadFromFile(
      "../images/tiles.png"); // load the tetris block sprite
  ...
  while (window.isOpen()) {
    ...
    // handle any window or keyboard events that have occured since the last
    // game loop
    sf::Event event;
